...
export class QuizControllerBase {
  ...
  async InitiateQuiz(
    ...
    return this.service.InitiateQuiz(body);
  }

  @common.Get("/:id/play-quiz")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async PlayQuiz(
    ...
    return this.service.PlayQuiz(body);
  }
  ...
  async UploadQuizData(
    ...
    return this.service.UploadQuizData(body);
  }

  @common.Get("/:id/upload-quiz-json")
  @swagger.ApiOkResponse({
    type: String,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async UploadQuizJson(
    ...
    return this.service.UploadQuizJson(body);
  }
}
